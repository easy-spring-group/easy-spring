...
public class ValidateCodeFilter extends OncePerRequestFilter implements InitializingBean {
    ...
    /**
     * 把自己的验证码过滤器加入的其中
     * 配合 {@link com.bcdbook.security.core.validate.code.ValidateCodeSecurityConfig} 中的 configure() 使用)
     ...
     * @param request 请求信息
     * @return com.bcdbook.security.core.validate.code.ValidateCodeType
     * @version V1.0.0-RELEASE
     */
