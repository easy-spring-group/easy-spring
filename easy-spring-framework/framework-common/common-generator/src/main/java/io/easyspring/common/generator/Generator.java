package io.easyspring.common.generator;
...
//                    "credit_credit_enhancement", "credit_credit_file",
//            "credit_credit_info", "credit_due_diligence"};
...
//            };
            ...
            // 借款模块
//            {"loan_insurance_application", "loan_loan_capital",
//            "loan_loan_enhancement_agency", "loan_loan_info",
//            "loan_remittance"};

            // 日志模块
//            {"log_business_log", "log_server_log"};

            // 消息模块
//            {"msg_email_log", "msg_message_template", "msg_text_message_log"};

            // 贷后模块
//            {"post_capital_repayment", "post_capital_repayment_plan", "post_legal_feedback",
