package io.easyspring.message.subset.email.impl;
...
import io.easyspring.message.subset.email.FileAttachmentBuilder;
import io.easyspring.message.subset.email.InputStreamAttachmentBuilder;
