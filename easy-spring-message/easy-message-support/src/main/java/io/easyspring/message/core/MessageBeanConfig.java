...
import io.easyspring.message.core.impl.DefaultEasyMessageTemplateServiceImpl;
import io.easyspring.message.core.impl.RedisMessageDelayCacheRepository;
import io.easyspring.message.core.subset.email.EmailMessageProcessor;
import io.easyspring.message.core.subset.email.EmailReceiver;
import io.easyspring.message.core.subset.email.impl.DefaultEmailMessageBuilder;
import io.easyspring.message.core.subset.email.impl.DefaultEmailMessageSender;
import io.easyspring.message.core.subset.sms.SmsMessage;
import io.easyspring.message.core.subset.sms.SmsMessageProcessor;
import io.easyspring.message.core.subset.sms.SmsReceiver;
import io.easyspring.message.core.subset.sms.impl.DefaultSmsMessageSender;
import io.easyspring.message.core.subset.system.SystemMessageProcessor;
import io.easyspring.message.core.subset.system.impl.DefaultSystemMessageBuilder;
import io.easyspring.message.core.subset.system.impl.DefaultSystemMessageSender;
import io.easyspring.message.core.properties.MessageConstants;
import io.easyspring.message.core.subset.email.EmailMessage;
import io.easyspring.message.core.subset.sms.impl.DefaultSmsMessageBuilder;
import io.easyspring.message.core.subset.system.SystemMessage;
import io.easyspring.message.core.subset.system.SystemReceiver;
