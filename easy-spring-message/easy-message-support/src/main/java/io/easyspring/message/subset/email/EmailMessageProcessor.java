...
import io.easyspring.message.EasyMessageException;
import io.easyspring.message.MessageBuilder;
import io.easyspring.message.MessageChannelType;
import io.easyspring.message.MessageSender;
import io.easyspring.message.impl.AbstractMessageProcessor;
...
public class EmailMessageProcessor extends AbstractMessageProcessor<EmailMessage> {
     ...
     */
    @Autowired
    private MessageBuilder<EmailMessage, EmailReceiver> emailMessageBuilder;
    /**
     * 邮件消息的发送器
     */
    @Autowired
    private MessageSender<EmailMessage> emailMessageSender;
